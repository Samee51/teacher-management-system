            ...
            {filteredTeachers.length > 0 ? (
              filteredTeachers.map((teacher, index) => (
                <tr key={teacher.id} className="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                  <td className="px-2 py-3 text-center text-gray-700 dark:text-gray-300">{index + 1}.</td>
                  ...
                  <td className="px-4 py-3 flex gap-2 text-gray-600 dark:text-gray-300 justify-evenly">
                    <button title="View" className="cursor-pointer"><Eye size={18} /></button>
                    <button title="Edit" className="cursor-pointer"><Pencil size={18} /></button>
                    <button title="Delete" className="text-red-500 dark:text-red-400 cursor-pointer"><Trash2 size={18} /></button>
                  </td>
                </tr>
              ))
            ) : (
